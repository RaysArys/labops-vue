...
exports.InitialSchema1786868981000 = void 0;
class InitialSchema1786868981000 {
    name = 'InitialSchema1786868981000';
    async up(queryRunner) {
        await queryRunner.query('CREATE EXTENSION IF NOT EXISTS "uuid-ossp"');
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('teknisi', 'laboran', 'kepala_lab', 'tata_usaha', 'wakil_dekan')`);
        await queryRunner.query(`CREATE TYPE "public"."assets_kategori_enum" AS ENUM('alat_ukur', 'jaringan', 'server_pc', 'iot_embedded', 'kelistrikan_ups', 'audio_visual', 'sparepart_bhp')`);
        await queryRunner.query(`CREATE TYPE "public"."assets_kondisi_enum" AS ENUM('baik', 'rusak', 'dalam_perbaikan', 'hilang', 'cadangan')`);
        await queryRunner.query(`CREATE TYPE "public"."assets_status_aset_enum" AS ENUM('aktif', 'maintenance', 'dipinjam', 'dihapuskan')`);
        await queryRunner.query(`CREATE TYPE "public"."assets_status_approval_enum" AS ENUM('draft', 'pending_approval', 'approved', 'rejected')`);
        await queryRunner.query(`CREATE TYPE "public"."work_orders_asal_temuan_enum" AS ENUM('manual', 'stock_opname', 'kalibrasi')`);
        await queryRunner.query(`CREATE TYPE "public"."work_orders_status_tiket_enum" AS ENUM('open', 'in_progress', 'resolved', 'closed', 'cancelled')`);
        await queryRunner.query(`CREATE TYPE "public"."work_orders_prioritas_enum" AS ENUM('rendah', 'sedang', 'tinggi', 'critical')`);
        await queryRunner.query(`CREATE TYPE "public"."stock_opname_periods_status_enum" AS ENUM('aktif', 'selesai')`);
        await queryRunner.query(`CREATE TYPE "public"."stock_opname_records_kondisi_fisik_enum" AS ENUM('baik', 'rusak', 'dalam_perbaikan', 'hilang', 'cadangan')`);
        await queryRunner.query(`CREATE TYPE "public"."stock_opname_records_status_temuan_enum" AS ENUM('sesuai', 'tidak_sesuai', 'tidak_ditemukan', 'kelebihan_fisik')`);
        await queryRunner.query(`CREATE TYPE "public"."stock_opname_records_status_tindak_lanjut_enum" AS ENUM('open', 'in_progress', 'selesai')`);
        await queryRunner.query(`CREATE TYPE "public"."calibration_schedules_status_kalibrasi_enum" AS ENUM('dijadwalkan', 'akan_jatuh_tempo', 'overdue', 'menunggu_perbaikan')`);
        await queryRunner.query(`CREATE TYPE "public"."calibration_logs_hasil_enum" AS ENUM('lulus', 'lulus_bersyarat', 'tidak_lulus')`);
        await queryRunner.query(`CREATE TYPE "public"."calibration_logs_status_approval_enum" AS ENUM('pending_approval', 'approved', 'rejected_dokumen', 'rejected_teknis')`);
        await queryRunner.query(`CREATE TYPE "public"."vendors_status_akreditasi_enum" AS ENUM('aktif', 'akan_expired', 'expired')`);
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_assets_no_inventaris" ON "assets" ("no_inventaris")`);
        await queryRunner.query(`CREATE INDEX "IDX_assets_lokasi_kategori" ON "assets" ("gedung", "lantai", "ruangan", "kategori")`);
        await queryRunner.query(`CREATE INDEX "IDX_audit_entity" ON "item_configuration_changes" ("entity_type", "entity_id", "waktu_perubahan")`);
        await queryRunner.query(`CREATE INDEX "IDX_work_orders_asset_status" ON "work_orders" ("asset_id", "status_tiket")`);
        await queryRunner.query(`CREATE INDEX "IDX_opname_records_periode" ON "stock_opname_records" ("periode_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_opname_records_asset_tindak_lanjut" ON "stock_opname_records" ("asset_id", "status_tindak_lanjut")`);
        await queryRunner.query(`CREATE INDEX "IDX_calibration_schedules_asset_due" ON "calibration_schedules" ("asset_id", "tanggal_jatuh_tempo", "status_kalibrasi")`);
        await queryRunner.query(`CREATE INDEX "IDX_calibration_logs_schedule" ON "calibration_logs" ("schedule_id", "tanggal_pelaksanaan")`);
        await queryRunner.query(`CREATE INDEX "IDX_calibration_logs_asset_vendor" ON "calibration_logs" ("asset_id", "vendor_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_vendors_expired" ON "vendors" ("tanggal_expired_akreditasi")`);
    }
...
exports.InitialSchema1786868981000 = InitialSchema1786868981000;
//# sourceMappingURL=1786868981000-InitialSchema.js.map